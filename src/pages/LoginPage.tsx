    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl w-full max-w-md relative z-10 border border-gray-100 flex flex-col items-center text-center space-y-6 animate-fadeIn">
        ...
        <div className="w-full flex items-center gap-4 py-2">
          ...
          <span className="text-[10px] text-gray-300 font-black uppercase tracking-widest">Ou</span>
          <div className="h-px bg-gray-100 flex-1"></div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white border-2 border-gray-100 text-gray-600 py-3 rounded-xl font-black text-xs uppercase tracking-widest shadow-sm hover:bg-gray-50 transition-all active:scale-95 flex items-center justify-center gap-3"
        >
